...
;MsgBox % ObjMaxIndex(myarray) " = " myarray.MaxIndex()
...
;================================================================================================
For k, v in myarray
    MsgBox % k . "=" . v.result.id

;================================================================================================
;第三種疊代。
;================================================================================================
/*
Test.Data := ResultJSON.results
...
(
{
    ...
    "results": [
        {
            "result": {
                "id": "patent/CN108140494A/zh",
                "number": "CN108140494A",
                "title": "蓄电组件、蓄电组件的制造方法、金属接合体和金属接合体的制造方法 "
            }
        }
    ]
}
